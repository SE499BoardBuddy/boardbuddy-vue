...
<template>
  ...
  >
    <p class="my-auto hidden lg:flex md:flex text-2xl w-[20%] font-semibold leading-none text-left h-fit  text-bb-white">
      Browse
    </p>
    <form class="lg:w-[60%] w-full leading-normal h-fit my-auto text-bb-white mx-auto">
