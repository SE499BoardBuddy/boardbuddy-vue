...
<template>
  ...
  <nav
    class="w-full z-2-nav pb-2 bg-bb-black h-[10vh] fixed bottom-0 right-0 left-0 lg:top-0 lg:w-[16%] lg:h-full lg:pl-2 border-t-2 border-bb-black-light lg:border-r-2 lg:border-t-0"
  >
